  ...
  head: () => ({
    meta: [
      ...
      { title: "Our Space — a private world for two" },
      {
        name: "description",
        content:
          "Our Space is a private home for couples: shared lists, plans, a date jar, memories and friendly competition — just the two of you.",
      },
      { property: "og:title", content: "Our Space — a private world for two" },
      {
        property: "og:description",
        content:
          "A private home for couples: shared lists, plans, a date jar and friendly competition.",
      },
